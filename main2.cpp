...
int main(int argc, char **argv)
{
    ...
    pretrained_binary_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/20150910-123935-a954_epoch_30.caffemodel");
    pretrained_binary_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/20150910-130216-e140_epoch_30.caffemodel");
    pretrained_binary_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/20150910-131710-08c4_epoch_30.caffemodel");
    pretrained_binary_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/20150910-105007-f00b_epoch_30.caffemodel");
    pretrained_binary_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/20150910-111320-ee5a_epoch_30.caffemodel");
    pretrained_binary_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/20150910-114251-a07b_epoch_30.caffemodel");

    // Text file (.prototxt) defining the network structure
    vector <string> feature_extraction_proto_file;
    feature_extraction_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/CaffeNet_day12_train_val.prototxt");
    feature_extraction_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/CaffeNet_day123_train_val.prototxt");
    feature_extraction_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/CaffeNet_day1234_train_val.prototxt");
    feature_extraction_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/CaffeNet_day12_train_val.prototxt");
    feature_extraction_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/CaffeNet_day123_train_val.prototxt");
    feature_extraction_proto_file.push_back("/data/giulia/DATASETS/iCubWorld28_experiments/CaffeNet_finetuned/models/CaffeNet_day1234_train_val.prototxt");
    ...
    out_dirs.push_back("TRday1day2");
    out_dirs.push_back("TRday1day2day3");
    out_dirs.push_back("TRday1day2day3day4");
    out_dirs.push_back("TRday12");
    out_dirs.push_back("TRday123");
    out_dirs.push_back("TRday1234");
    ...
    for (int m=0; m<pretrained_binary_proto_file.size(); m++) {
    	...
    	for (int d=0; d<4; d++)  {
    		...
    		string out_dir = out_rootdir + out_dirs[m] + "TEday" + patch::to_string(d+1);
